...
|--------|--------------|-------------------------|-------------|--------------|---------|----------------|
| R-001 | {描述} | D-001 / STATE-default | 2.3 检索组件 | IF-001 | MUST | 给定 {输入}，{可验证结果}（Given/When/Then）|
| R-002 | {描述} | D-00N / STATE-... | {节号} | IF-00N / CMP-00N | MUST | 给定 {输入}，{可验证结果} |
| AE-001 | {AI 边界描述} | D-00N / STATE-... | {节号} | CMP-00N | MUST | {可观测验证} |
