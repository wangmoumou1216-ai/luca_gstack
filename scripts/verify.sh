...
check S45 "六项集成 runtime candidate manifest denominator/blob 闭合" "node scripts/candidate-manifest.mjs --verify framework-audit/2026-08-30-mattpocock-six-skills-integration/CANDIDATE-MANIFEST.tsv"
