...
- **红队四轮：三轮自攻 + 第四轮独立冷启动（fable）。** 第四轮打掉两条 BLOCKER + 一条降级误判，
  且都是自攻找不到的维度。**已有外部视角。** 是否再来一轮由 luca 定。
...
- **非负条款有效性仍未证明**，但其**执行方式**已在第四轮修正（隔离拷贝 + 阳性对照先行，
  不再要求在活体钩子上原地降级）。未证明这件事本身照旧如实标注，不冒充完成。
