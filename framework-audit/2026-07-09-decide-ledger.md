...
| **F6-04** 双仓拓扑不可持续 | **已终裁-已执行（2026-07-16）** | 决策：① fork 远程备份（backup remote 已在位）；② 母版已 push（#2 完成）；③ 母版-first 纪律（本台账项 1）。**终裁：B2 单真值源 + 双检出——muse 分支 merge 回 main（union），两目录降为 main 的双检出，parity 机制降级仓内自检。全文见 `2026-07-16-b2-merge-closure.md`** |
