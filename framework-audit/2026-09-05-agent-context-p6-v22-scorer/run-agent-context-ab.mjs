...
import { runBranchFixtureContractTests } from './test-agent-context-branch-fixtures.mjs';
...
const SCORING_REVISION = 'v22-declared-contract-edges-and-frozen-release-binding';
