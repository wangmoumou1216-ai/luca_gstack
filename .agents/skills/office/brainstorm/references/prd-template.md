...
Self-audit the draft against these 14 questions. If ANY answer is "no" or "unclear," fix before writing to disk.
...
12. **The key question**: If `/ux-research`, `/ux-brainstorm`, `/design-brief`, or
...
13. If Phase 2.5 judged `fully_native` or `partially_native`, is the AI Native Assessment section
    filled AND does `prd-ai-spec.md` exist?
14. If Phase 2.5 flagged `agent_boundary_needed`, is the Agent Boundary Declaration section present
